<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#0A9396" fill-opacity="1" d="M0,224L80,229.3C160,235,320,245,480,250.7C640,256,800,256,960,245.3C1120,235,1280,213,1360,202.7L1440,192L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path></svg>
<footer>
    <footer class="footer footer-center p-10 bg-body text-primary-content">
        <div>
          ...
          <p class="font-bold">
            PT Memjukan Negara <br/>Providing reliable tech since 1945
          </p>
